...
public class PlayerControllerX : MonoBehaviour
{
    ...
    private float groundBound = 1.0f;
    ...
    void Update()
    {
        ...
        if (transform.position.y < groundBound && !gameOver)
        {
            transform.position = new Vector3(transform.position.x, groundBound, transform.position.z);
            playerRb.AddForce(Vector3.up * floatForce * boingVal);
